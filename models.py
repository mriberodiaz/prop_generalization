...
from keras.layers import Dense, Conv1D, MaxPool1D, Input, Flatten, MaxPooling1D, Dropout,Conv2D, MaxPooling2D, Dropout, BatchNormalization
...
def dense_batch_norm(ax = -1):
    input_layer = Input(shape = (737,), name = 'input_layer')
    x = BatchNormalization(axis = ax)(input_layer)
    # Embedding
...
def conv_dense_k5_f8(desc = 'conv_dense_'):
  input_layer = Input(shape = (736,1), name = 'input_layer')
  x = Conv1D(filters = 8, kernel_size = 5, activation='relu', padding = 'same')(input_layer)
...
def conv_dense_k5_f8_l2(desc = 'conv_dense_'):
  input_layer = Input(shape = (736,1), name = 'input_layer')
  x = Conv1D(filters = 8, kernel_size = 5, activation='relu', padding = 'same', kernel_regularizer=regularizers.l2(0.01))(input_layer)
  x = MaxPooling1D(pool_size=2, padding='valid', strides = 2)(x)
  x = Flatten()(x)
  auxiliary_input = Input(shape=(1,), name='aux_input')
  x = keras.layers.concatenate([x, auxiliary_input])
...
def conv_dense_k5_f8_val(desc = 'conv_dense_'):
	input_layer = Input(shape = (736,1), name = 'input_layer')
	x = Conv1D(filters = 8, kernel_size = 5, activation='relu', padding = 'valid')(input_layer)
	x = MaxPooling1D(pool_size=2, padding='valid', strides = 2)(x)
	x = Flatten()(x)
	auxiliary_input = Input(shape=(1,), name='aux_input')
	x = keras.layers.concatenate([x, auxiliary_input])
...
def conv_dense_k3_f8_val(desc = 'conv_dense_'):
	input_layer = Input(shape = (736,1), name = 'input_layer')
	x = Conv1D(filters = 8, kernel_size = 3, activation='relu', padding = 'valid')(input_layer)
	x = MaxPooling1D(pool_size=2, padding='valid', strides = 2)(x)
	x = Flatten()(x)
	auxiliary_input = Input(shape=(1,), name='aux_input')
	x = keras.layers.concatenate([x, auxiliary_input])
...
def conv_drop(desc = 'conv_dense_'):
  input_layer = Input(shape = (736,1), name = 'input_layer')
  x = Conv1D(filters = 8, kernel_size = 5, activation='relu', padding = 'same')(input_layer)
  x = MaxPooling1D(pool_size=2, padding='valid', strides = 2)(x)
  x = Flatten()(x)
